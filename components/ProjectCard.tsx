  ...
  return (
    <div 
      ...
      className={`group cursor-pointer reveal transition-all duration-700 p-6 rounded-[2.5rem] 
        ...
        hover:bg-white/5 dark:hover:bg-stone-800/20 hover:shadow-stone-300/50 dark:hover:shadow-stone-950/50 hover:border-white/60 dark:hover:border-white/10
        ${index % 2 !== 0 ? 'md:mt-32' : ''}`}
      style={{
        perspective: '1000px',
      }}
    >
      ...
      >
        ...
        <div 
          className="absolute inset-0 bg-stone-900/10 dark:bg-black/20 backdrop-blur-[2px] flex items-center justify-center transition-all duration-700 opacity-0 group-hover:opacity-100 z-20 focus:outline-none"
        >
          <div 
      ...
      <div className="space-y-5 px-3 transition-transform duration-500 ease-out group-hover:translate-x-1">
        ...
        <div className="pt-2">
          ...
          >
            <span className="relative z-10 transition-colors duration-500 group-hover/link:text-stone-900 dark:group-hover/link:text-stone-100">Explore Story</span>
