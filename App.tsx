...
const App: React.FC = () => {
  ...
  return (
    <>
      <Loader isDarkMode={isDarkMode} onFinish={() => setIsLoading(false)} />
      
      <div className={`relative antialiased text-stone-900 bg-[#f8f7f4] selection:bg-stone-200 dark:bg-stone-950 dark:text-stone-100 transition-colors duration-500 ${isLoading ? 'h-screen overflow-hidden' : 'min-h-screen'}`}>
        <ScrollProgress />
          ...
          <section id="contact" className="py-60 bg-stone-900 text-white text-center">
            <div className="container mx-auto px-6 reveal">
              ...
              <div className="flex justify-center flex-wrap gap-16 text-stone-500 uppercase tracking-[0.3em] text-[10px] font-bold">
                <a href="https://www.linkedin.com/in/awanish-verma/" target="_blank" rel="noopener" className="group relative hover:text-white transition-colors duration-500">
                  LinkedIn
